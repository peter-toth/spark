...
import org.apache.spark.sql.execution.{AliasAwareOutputOrdering, AliasAwareOutputPartitioning, SparkPlan, UnaryExecNode}
...
case class SortAggregateExec(
    ...
    child: SparkPlan)
  extends UnaryExecNode with AliasAwareOutputPartitioning with AliasAwareOutputOrdering {
