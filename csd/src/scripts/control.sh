...
SPARK_VERSION_FILE="$SPARK_HOME/cloudera/spark3_version.properties"


echo "SPARK HOME: ${SPARK_HOME}"
echo "SPARK VERSION FILE: ${SPARK_VERSION_FILE}"
...
if [ "$CSD_VERSION" != "$SPARK_VERSION_WITHOUT_SNAPSHOT" ]; then
  ...
  echo "* Spark 3 version ($SPARK_VERSION_WITHOUT_SNAPSHOT). Either update your CSD or      "
