...
class ExecutorMonitorSuite extends SparkFunSuite with BeforeAndAfterEach {
  ...
  ignore("SPARK-27677: don't track blocks stored on disk when using shuffle service") {
