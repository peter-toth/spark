    ...
    withCountListingLocalFileSystemAsLocalFileSystem {
      withThreeTempDirs { case (src, meta, tmp) =>
        ...
        (0 to 3).foreach { batchId =>
          val offsetBatch = source.getOffset.get.asInstanceOf[FileStreamSourceOffset]
        ...
        val offsetBatch2 = source.getOffset.get.asInstanceOf[FileStreamSourceOffset]
  ...
  test("Don't cache unread files when latestFirst is true") {
    withCountListingLocalFileSystemAsLocalFileSystem {
      withThreeTempDirs { case (src, meta, tmp) =>
        ...
        source.getOffset.get.asInstanceOf[FileStreamSourceOffset]
